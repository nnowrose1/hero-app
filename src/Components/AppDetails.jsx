...
import { addAppstoLS, getAppFromLS } from "../utility/localStorage";
...
const AppDetails = () => {
  ...
  useEffect(() => {
  const installedAppIds = getAppFromLS();
      ...
      <div className="container mx-auto">
        ...
        <div className="border-b-2 border-gray-200 pb-6 md:pb-10 flex flex-col md:flex-row gap-6 md:gap-10">
          ...
          <div>
            ...
            <p className="text-xl text-[#627382] border-b-1 border-gary-200 mt-2 pb-8">
              Developed by{" "}
            ...
            <button
              ...
              disabled={clicked}
              className="rounded-sm text-white bg-[#00D390] px-5 py-4 font-semibold text-xl mt-8"
            >
        ...
        {/* bottom */}
        <div>
          <h3 className="mt-10 mb-6 font-semibold text-2xl text-[#001931]">
            Description
          </h3>
